...
class ReviewsProcessing():
    ...
    def getprocessedreviews(self):
        ...
        for row in freader:
          if (row[dictOfColumns['Review Title']] and row[dictOfColumns['Review Text']]):
        ...
        self.all_processed_review.append(
            [self.userInterface_object.final_list, self.userInterface_object.category_name])
        self.all_processed_review.append(
            [self.compatibility_object.final_list, self.compatibility_object.category_name])
